export const ROUTES = [
    { path: '/dashboard', title: 'Statistiques', icon: 'dashboard', children: null },
    //{ path: 'profile', title: 'User Profile', icon: 'person', children: null },
    { path: 'commercant', title: 'Commerçants', icon: 'content_paste', children: null },
    { path: 'user', title: 'Utilisateurs', icon: 'person', children: null },
